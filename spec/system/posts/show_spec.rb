...
RSpec.describe 'posts/show', type: :feature do
  before(:each) do
    ...
    @first_post = Post.create(author: @author, title: 'Tom Post #1', body: "This is Tom's first post")
    @first_comment = Comment.create(post: @first_post, author: @author, body: 'First comment for Tom')
    @second_comment = Comment.create(post: @first_post, author: @author, body: 'Second comment for Tom')
    @third_comment = Comment.create(post: @first_post, author: @author, body: 'Third comment for Tom')
  ...
  it "shows the comment's body" do
