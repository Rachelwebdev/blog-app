...
RSpec.describe 'posts/index', type: :feature do
  before :each do
    ...
    @author = User.create(name: 'Tom', photo: @img, bio: 'Teacher from South Africa', post_count: 2)
    @first_post = Post.create(author: @author, title: 'Tom Post #1', body: "This is Tom's first post")
    @second_post = Post.create(author: @author, title: 'Tom Post #2', body: "This is Tom's second post")
